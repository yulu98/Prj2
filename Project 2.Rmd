...
First we chech if there are words that may have been mischaracterized. 
...
tidy_combined <- bind_rows(tidy_books, tidy_books_1, tidy_books_2)
...
The three topics showed somewhat characters of these three ladies writing and their usage of femine words. But there is no clear distinctions
